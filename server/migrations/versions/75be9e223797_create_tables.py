...
Revision ID: 75be9e223797
Revises: 
Create Date: 2023-08-10 01:21:12.926240
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['course_id'], ['courses.Course_ID'], name=op.f('fk_requests_course_id_courses')),
